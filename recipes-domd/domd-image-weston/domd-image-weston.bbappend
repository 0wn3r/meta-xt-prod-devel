...
SRC_URI = " \
    repo://github.com/0wn3r/manifests;protocol=https;branch=REL-v7.0;manifest=${XT_MANIFEST_FOLDER}/domd.xml;scmdata=keep \
"
...
configure_versions_rcar() {
    ...
    cd ${S}
    base_update_conf_value ${local_conf} PREFERRED_PROVIDER_gles-user-module ""
    base_update_conf_value ${local_conf} PREFERRED_PROVIDER_kernel-module-gles ""
    base_update_conf_value ${local_conf} PREFERRED_PROVIDER_gles-module-egl-headers ""
